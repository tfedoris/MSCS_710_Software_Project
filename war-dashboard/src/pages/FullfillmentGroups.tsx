...
import { Values } from "../components/organisms/AddFullfillmentGroup";
import AddFullfillmentGroup from "components/organisms/AddFullfillmentGroup";
import FullfillmentGroupsTable from "components/organisms/FullfillmentGroupsTable";

const API_ENDPOINT =
  "https://iafulfillmentgroupservice.azurewebsites.net/api/fulfillmentgroup";
...
export default function FullfillmentGroups() {
  ...
  return (
    <>
      ...
      <h1 style={{ textAlign: "left" }}>Fullfillment Groups</h1>
      <AddFullfillmentGroup onSubmit={handleSubmit()} />
      <div className={classes.spacer}>.</div>
      <FullfillmentGroupsTable rows={contacts.data} />
    </>
  );
