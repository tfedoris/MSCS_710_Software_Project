...
import { Values } from "../components/organisms/AddContact";
import ContactsTable from "components/organisms/ContactsTable";

const API_ENDPOINT = "https://iacontactservice.azurewebsites.net/api/contact";
...
export default function Contacts() {
  ...
  return (
    <>
      ...
      <ContactsTable rows={contacts.data} />
    </>
  );
